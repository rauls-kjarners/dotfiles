return {
  {
    ...
    config = function(_, opts)
      ...
      local function apply_alucard_fg()
        ...
        local fg = "#1f1f1f"
        local groups = {
          "lualine_a_normal",  "lualine_z_normal",
          "lualine_b_normal",  "lualine_c_normal",  "lualine_x_normal",  "lualine_y_normal",
          "lualine_b_insert",  "lualine_c_insert",  "lualine_x_insert",  "lualine_y_insert",
          "lualine_b_visual",  "lualine_c_visual",  "lualine_x_visual",  "lualine_y_visual",
          "lualine_b_replace", "lualine_c_replace", "lualine_x_replace", "lualine_y_replace",
          "lualine_b_command", "lualine_c_command", "lualine_x_command", "lualine_y_command",
        }
      ...
      vim.api.nvim_create_autocmd("ColorScheme", {
        callback = function() vim.schedule(apply_alucard_fg) end,
      })
